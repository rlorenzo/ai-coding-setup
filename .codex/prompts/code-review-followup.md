---
description: 'Code review follow-up'
---
...
IMPORTANT: You MUST overwrite agent-code-review.md with your updated review findings. If all issues are resolved, write the report with "Verdict: good to go" and zero issue counts.
